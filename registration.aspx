<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="StudentSystem.registration"%>
                    ...
                    <td class="auto-style2">   
                        <asp:GridView ID="GridRegistration" runat="server" Width="734px" CellPadding="4" ForeColor="#333333" GridLines="None" Height="264px" OnSelectedIndexChanged="GridRegistration_SelectedIndexChanged" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Date" DataField="date" DataFormatString="{0:dd MMMM yyyy}" />
                                <asp:BoundField HeaderText="Presence" DataField="presence" />
                                <asp:BoundField HeaderText="Absence" DataField="absence" />
